...
### 共通機能
- **月間サマリー、残業警告、打刻漏れ**はポップアップ・ホーム画面の両方で表示されます
- **セクション折りたたみ**: 月間サマリー、残業警告、打刻漏れの各セクションはヘッダーをクリックすると折りたたみ/展開できます
...
### その他
- **TeamSpiritを開く**: フッターのリンクからTeamSpiritを直接開けます
- **ログアウト**: フッターのリンクからログアウトできます
...
| 項目 | 説明 | 計算式 |
|------|------|--------|
| **勤務日数** | 当月の勤務日数（当日を含む） | TeamSpirit実出勤日数 + 1（今日出勤打刻がある場合） |
